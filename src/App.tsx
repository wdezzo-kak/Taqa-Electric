  ...
  return (
    <div className="min-h-screen bg-background" dir={lang === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <main className="content-container">
        ...
        <section id="vision" className="vision-section"><Vision t={t} lang={lang} /></section>
        ...
        <section id="projects" className="project-section"><ProjectCase t={t} lang={lang} /></section>
        <section id="brands" className="brands-section"><BrandEcosystem /></section>
        <section id="contact" className="contact-section"><Contact t={t} lang={lang} /></section>
      </main>
